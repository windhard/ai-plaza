...
const { chapters: chapters1 } = await parseScript(md1);
...
const { chapters: chapters2 } = await parseScript(md2);
...
const { chapters: chapters3 } = await parseScript(story);
...
const { chapters: chapters5 } = await parseScript(md5);
